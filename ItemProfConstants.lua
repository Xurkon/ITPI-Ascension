...
-- Robust 'bit' library check for 3.3.5a
if not bit then
    bit = {
        band = function(a, b) return math.floor(a) % (2*b) >= b and b or 0 end,
        lshift = function(a, b) return a * (2^b) end,
        rshift = function(a, b) return math.floor(a / (2^b)) end,
    }
end

-- Texture mapping for the icons
-- Note: Direct file paths are used for maximum reliability in the 3.3.5a client
ItemProfConstants.PROF_TEXTURES = {
[ COOK ] = "Interface\\Icons\\inv_misc_food_15",
[ FAID ] = "Interface\\Icons\\inv_misc_bandage_01",
[ ALC ] = "Interface\\Icons\\trade_alchemy",
[ BS ] = "Interface\\Icons\\trade_blacksmithing",
[ ENC ] = "Interface\\Icons\\trade_engraving",
[ ENG ] = "Interface\\Icons\\trade_engineering",
[ LW ] = "Interface\\Icons\\trade_leatherworking",
[ TAIL ] = "Interface\\Icons\\trade_tailoring",
[ JC ] = "Interface\\Icons\\inv_misc_gem_01",
[ INS ] = "Interface\\Icons\\inv_inscription_inkbird01",
[ Q ] = "Interface\\GossipFrame\\AvailableQuestIcon",
[ DMF ] = "Interface\\Icons\\inv_misc_ticket_tarot_01"
}

-- Getter for textures
function ItemProfConstants:GetTexture(bitMask)
    return self.PROF_TEXTURES[bitMask]
end
